...
| `ALLOWED_ORIGINS` | Comma-separated list of allowed origins for password reset links (e.g., `https://bmxkalender.be,https://www.bmxkalender.be`). The `VITE_SUPABASE_URL` is always included automatically. |
